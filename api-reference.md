...
```json
{
  ...
  "first_floor": {
    ...
    "agree": {
      "agree_num": 652,
      "disagree_num": 1,
      "has_agree": 0 // 当前用户是否已赞主帖：0 未赞 / 1 已赞；配合 opAgree op_type 0 赞 / 1 取消
    }
  },
  "post_list": [
    {
      ...
      "agree": {
        "agree_num": 0,
        "has_agree": 0 // 楼层点赞数与是否已赞（字段名同 nestedFloor / 楼层详情）
      },
      "sub_post_list": {
        "sub_post_list": [
          {
